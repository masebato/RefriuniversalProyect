...
namespace RefriuniversalProyect.Models
{
    public class OrdenServicio
    {
        ...
        {
            return con.OperarDatos("insert into ordenservicio (descORDENSERVICIO,codiORDENSERVICIO,fechaORDENSERVICIO,estadoORDENSERVICIO,CLIENTE_idCLIENTE,TECNICO_idTECNICO) values('" + orden.descORDENSERVICIO+"','"+orden.codiORDENSERVICIO+"', '"+orden.fechaORDENSERVICIO+"','"+orden.estadoORDENSERVICIO+"','"+orden.clienteORDENSERVICIO+"','"+orden.tecnicoORDENSERVICIO+"')");
        }
